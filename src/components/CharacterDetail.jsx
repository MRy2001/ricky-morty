...
function CharacterDetail({selectedId, onAddFavourite,favList}) {
...
if(isLoading)
return(
  <div className="" style={{flex:1}}><Loader/>
  </div>
  ...
  return (
    <div style={{flex:1}}>
  <CharacterSubInfo character={character} onAddFavourite={onAddFavourite} favList={favList} selectedId={selectedId}/>
...
function CharacterSubInfo({character,favList,selectedId,onAddFavourite}){
   ...
   className='character-detail__img'
    ...
    <div className="character-detail__info">
      ...
      <div className="actions">
        {favList.includes(selectedId) ? <p>Already Added to Favourite ✅</p>: <button onClick={()=>onAddFavourite(character)} className='btn btn--primary'>Add to Favourite</button> 
}
       </div>
    </div>
</div>
